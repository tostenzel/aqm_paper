...
df = data.frame(Austria, Azerbaijan, Bahrain, Uruguay, Venezuela, Argentina)
rownames(df) = iter1
...
ggplot(data = df) +
  geom_line(aes(x = iter1, y = Austria)) + 
  geom_point(aes(x = iter1, y = Austria)) +
   geom_line(aes(x = iter1, y = Azerbaijan)) + 
  geom_point(aes(x = iter1, y = Azerbaijan)) +
   geom_line(aes(x = iter1, y = Bahrain)) + 
  geom_point(aes(x = iter1, y = Bahrain)) +
   geom_line(aes(x = iter1, y = Uruguay)) + 
  geom_point(aes(x = iter1, y = Uruguay)) +
   geom_line(aes(x = iter1, y = Venezuela)) + 
  geom_point(aes(x = iter1, y = Venezuela)) +
   geom_line(aes(x = iter1, y = Argentina)) + 
  geom_point(aes(x = iter1, y = Argentina))
