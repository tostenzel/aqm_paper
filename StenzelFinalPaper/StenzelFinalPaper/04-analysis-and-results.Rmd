...
Why not models and priors (Claassen), proposal dist (Stan) but warmup, n_chains and n_iters. (Even though convergence diagnostics) -> Principle of minimal iterations 
