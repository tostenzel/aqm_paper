...
df_plot %>%
  ...
  ggplot(aes(x = years, y = theta, colour = Country)) + grids(linetype = "dashed")  + geom_line()  + geom_point() + xlab("Year") + ylab(TeX("$\\hat{\\theta}$")) + scale_colour_brewer(palette="Paired", labels = c("US",  "US updated", "China", "China updated", "South Africa", "South Africa updated"))
