...
```{r sparse-data, label="sparse-data", include=TRUE, echo=FALSE, fig.cap="Sparseness of Aggregate Support for Democacy By Country, Year, and Survey Item. The figure is an update of Figure 1 in Claassen (2019).", warning=FALSE, fig.pos="H"}
