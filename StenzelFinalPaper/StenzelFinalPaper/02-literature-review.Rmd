...
Regarding the second theory, instrumental regime performance, PSD rises if the system performs well in terms of instrumental benefits such as economic growth, and it declines if regimes perform poorly [@Dalton1994; @Magalhaes2014]. Hence, the theory suggests that PSD should decline during economic crises. However, there are case-studies that find [@Dalton1994; @Magalhaes2014; @Mishler1996] and that do not find  find this relationship in the data (@Graham2004).
