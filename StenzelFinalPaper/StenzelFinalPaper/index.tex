...
\hypertarget{selection-of-hyperparameters}{%
\subsection{Selection of Hyperparameters}\label{selection-of-hyperparameters}}

Why not models and priors (Claassen), proposal dist (Stan) but warmup, n\_chains and n\_iters. (Even though convergence diagnostics) -\textgreater{} Principle of minimal iterations
